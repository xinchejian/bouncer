...
$result = $link->exec("SELECT id,email,CAST(submitted AS DATE) as submitted,amount FROM members.Payments WHERE verified IS NULL;")
	or mail_and_die('link->exec SELECT error', __FILE__);
